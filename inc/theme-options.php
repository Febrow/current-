    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'     => 'switch',
                'title'    => esc_html__('Mouse Move Animation', 'alico'),
                'default'  => false
            ),
        )
    ));
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            array(
                'id'       => 'header_type',
                'type'     => 'button_set',
                'title'    => esc_html__('Header Type', 'alico'),
                'options'  => array(
                    'default'  => esc_html__('Default Layout', 'alico'),
                    'builder'  => esc_html__('Builder Layout', 'alico')
                ),
                'default'  => 'default',
            ),
            ...
            array(
                'id'          => 'e_header_layout',
                'type'        => 'select',
                'title'       => esc_html__('Main Header Layout', 'alico'),
                'desc'        => sprintf(esc_html__('To use this Option please %sClick Here%s to add your header layout first.','alico'),'<a href="' . esc_url( admin_url( 'edit.php?post_type=header' ) ) . '">','</a>'),
                'options'     => alico_list_post('header'),
                'default'     => '',
                'required' => array( 0 => 'header_type', 1 => 'equals', 2 => 'builder' ),
            ),
            array(
                'id'          => 'e_header_layout_sticky',
                'type'        => 'select',
                'title'       => esc_html__('Sticky Header Layout', 'alico'),
                'desc'        => sprintf(esc_html__('To use this Option please %sClick Here%s to add your header layout first.','alico'),'<a href="' . esc_url( admin_url( 'edit.php?post_type=header' ) ) . '">','</a>'),
                'options'     => alico_list_post('header'),
                'default'     => '',
                'required' => array( 0 => 'header_type', 1 => 'equals', 2 => 'builder' ),
            ...
            array(
                ...
                'default'  => '1',
                'required' => array( 0 => 'header_type', 1 => 'equals', 2 => 'default' ),
            ),
            array(
                'id'       => 'h_bg_color',
                'type'     => 'background',
                'title'    => esc_html__('Background Color', 'alico'),
                'subtitle' => esc_html__('Apply header layout 1.', 'alico'),
                'output'   => array('#ct-header-wrap.ct-header-layout1 .ct-header-navigation::before, #ct-header-wrap.ct-header-layout1 .ct-header-navigation::after'),
            ...
            array(
                'id'      => 'h_social_whatsapp_url',
                'type'    => 'text',
                'title'   => esc_html__('WhatsApp URL', 'alico'),
                'default' => '',
                'required' => array( 0 => 'header_type', 1 => 'equals', 2 => 'default' ),
            ),
        )
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'logo_light',
                'type'     => 'media',
                'title'    => esc_html__('Logo Light', 'alico'),
                'default' => array(
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => esc_html__('Icon Has Children', 'alico'),
                'options'  => array(
                    'plus'  => esc_html__('Plus', 'alico'),
                    'arrow'  => esc_html__('Arrow', 'alico'),
                    'hidden'  => esc_html__('None', 'alico'),
                ),
                'default'  => 'plus',
                'required' => array( 0 => 'header_type', 1 => 'equals', 2 => 'default' ),
            ),
