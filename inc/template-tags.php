...
{
    $header_type = alico_get_opt( 'header_type', 'default' );
    $header_type_page = alico_get_page_opt( 'header_type', 'inherit' );
    if(isset($header_type_page) && !empty($header_type_page) && $header_type_page !== 'inherit') {
...
if ( ! function_exists( 'alico_post_meta' ) ) :
    function alico_post_meta() {
        ...
        $post_categories_on = alico_get_opt( 'post_categories_on', true );
...
function alico_social_header() {
    ...
    $h_social_whatsapp_url = alico_get_opt( 'h_social_whatsapp_url' );
    if(!empty($social_facebook_url) || !empty($social_twitter_url) || !empty($social_inkedin_url) || !empty($social_instagram_url) || !empty($social_google_url) || !empty($social_skype_url) || !empty($social_pinterest_url) || !empty($social_vimeo_url) || !empty($social_youtube_url) || !empty($social_yelp_url) || !empty($social_tumblr_url) || !empty($social_tripadvisor_url)) : ?>
        <div class="ct-header-social">
            ...
            if(!empty($h_social_whatsapp_url)) :
                echo '<a href="'.esc_url($h_social_whatsapp_url).'" target="_blank"><i class="fab fac-whatsapp"></i></a>';
            endif; ?>
        </div>
    <?php endif; ?>
<?php }
            ...
            foreach ($posts as $key => $post):
                ...
                <div class="<?php echo esc_attr($item_class . ' ' . $filter_class); ?>">
                    <div class="grid-item-inner <?php echo esc_attr($ct_animate); ?>" data-wow-duration="1.2s">
                        <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): ?>
                            <div class="item--featured">
                                <a href="<?php if(!empty($service_custom_link)) { echo esc_url($service_custom_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>"><?php echo ct_print_html($thumbnail); ?></a>
                            </div>
                        <?php endif; ?>
...
function alico_demo_bar() { ?>
    <div class="ct-demo-bar">
        <div class="ct-demo-option">
            ...
            <a href="https://themeforest.net/cart/add_items?item_ids=26053893" target="_blank">
            ...
            <div class="ct-demo-bar-list">
                <div class="ct-demo-bar-item">
                    ...
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-1-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 01</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo2.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-4/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-4-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 02</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo3.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-2/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-2-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 03</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo4.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-3/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-3-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 04</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo5.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-5/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-5-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 05 (Dark)</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo6.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-6/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-6-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 06</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo7.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-7/" target="_blank">Multi Pages</a>
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-7-one-page/" target="_blank">One Page</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo 07</h6>
                <div class="ct-demo-bar-item">
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/home-demo/demo-rtl.jpg'); ?>" alt="Demo" />
                    <div class="ct-demo-bar-holder">
                        <div class="ct-demo-btn">
                            <a class="btn btn-default" href="http://demo.casethemes.net/alico/home-rtl/?d=rtl" target="_blank">View Demos</a>
                        </div>
                    </div>
                </div>
                <h6 class="ct-demo-title">Demo RTL</h6>
            </div>
        </div>
    </div>
<?php }
...
function alico_add_cpt_support() {
    ...
    if( ! $cpt_support ) {
        $cpt_support = [ 'page', 'post', 'portfolio', 'service', 'footer', 'ct-mega-menu', 'header' ];
...
function alico_mouse_move_animation() { 
    $mouse_move_animation = alico_get_opt( 'mouse_move_animation', false );
    if($mouse_move_animation) {
        wp_enqueue_script( 'alico-cursor', get_template_directory_uri() . '/assets/js/cursor.js', array( 'jquery' ), '1.0.0', true ); ?>  
