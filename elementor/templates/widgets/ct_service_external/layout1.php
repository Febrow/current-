                ...
                <?php foreach ($settings['service'] as $key => $value): 
                    ...
                    if ( $has_icon ) {
                        ...
                        <div class="slick-slide">
                            <div class="item--inner ct-flipbox <?php echo esc_attr($settings['ct_animate']); ?>">
                                <div class="ct-flipbox--wrap">
                                    ...
                                    <div class="item--back ct-flipbox--back bg-image" <?php if(!empty($img['url'])) : ?>style="background-image: url(<?php echo esc_url($img['url']); ?>);"<?php endif; ?>>
                                        <?php if ( $icon_type == 'icon' && $has_icon ) : ?>
                                            <div class="item--icon">
                                                <?php if($is_new):
                                                    \Elementor\Icons_Manager::render_icon( $selected_icon, [ 'aria-hidden' => 'true' ] );
                                        ...
                                        <div class="item--meta">
                                            ...
                                            <?php if(!empty($btn_text)) : ?>
                                                <div class="item--readmore">
                                                    <a class="btn-text-gr" <?php echo implode( ' ', [ $link_attributes ] ); ?>>
