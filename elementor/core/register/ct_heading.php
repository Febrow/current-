...
ct_add_custom_widget(
    array(
        'name' => 'ct_heading',
        'title' => esc_html__('Case Heading', 'alico' ),
        'icon' => 'eicon-heading',
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style-default' => 'Style 1 - Default',
                                'style-line' => 'Style 2 - Line Shape',
                                'style3' => 'Style 3',
                                'style4' => 'Style 4 - Right Dot',
                                'style5' => 'Style 5 - Left/Right Dot',
                            ],
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'h_width',
                            'label' => esc_html__('Max Width', 'alico' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px', '%' ],
                            'range' => [
