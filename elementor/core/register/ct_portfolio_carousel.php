...
ct_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Portfolio Carousel', 'alico' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Category Typography', 'alico' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-slick-slider .item--category',
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-slick-slider .item--title, {{WRAPPER}} .ct-slick-slider .item--number',
                        ),
                    ),
                ),
                array(
