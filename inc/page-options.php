	...
	$metabox->add_section( 'page', array(
		...
		'fields' => array(
			...
			array(
	            ...
	            'options'  => array(
	                'inherit'  => esc_html__('Inherit', 'alico'),
	        ...
	        array(
	            'id'       => 'e_logo_mobile',
	            'type'     => 'media',
	            'title'    => esc_html__('Logo Mobile', 'alico'),
	            'default' => '',
	            'required'     => array( 0 => 'header_type', 1 => 'equals', 2 => 'builder' ),
				'force_output' => true
	        ),
	        ...
	        array(
                'id'       => 'h_custom_menu',
                'type'     => 'select',
                'title'    => esc_html__( 'Custom Menu', 'alico' ),
                'subtitle' => esc_html__( 'Custom menu for current page.', 'alico' ),
                'options'  => alico_get_nav_menu(),
                'default' => '',
            ),
		)
	) );
	...
	$metabox->add_section( 'page', array(
		...
		'fields' => array(
	        ...
	        array(
	            'id'          => 'gradient_color',
	            'type'        => 'color_gradient',
	            'title'       => esc_html__('Gradient Color', 'alico'),
	            'transparent' => false,
	            'default'  => array(
	                'from' => '',
	                'to'   => '', 
	...
	$metabox->add_section( 'portfolio', array(
		...
		'fields' => array(
			array(
	            ...
	            'type'     => 'ct_iconpicker',
	            'title'    => esc_html__('Icon Font', 'alico'),
	        ),
			array(
