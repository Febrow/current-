 ...
 * @package Alico
 */
$page_404 = alico_get_opt( 'page_404', 'default' );
$page_custom_404 = alico_get_opt( 'page_custom_404' );
get_header(); ?>
                            ...
                            <div class="error-404-content">
                                <div class="error-404-holder">
                                    ...
                                    <h3 class="error-404-title">
                                        <?php echo esc_html__('Sorry! Page Not Found!', 'alico'); ?><br/>
                                    </h3>
                                    <div class="error-404-desc"><?php echo esc_html__('Oops! The page you are looking for does not exist. Please return to the site’s homepage.', 'alico'); ?></div>
