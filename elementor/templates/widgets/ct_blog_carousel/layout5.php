                ...
                <div class="grid-item-inner <?php echo esc_attr($settings['ct_animate']); ?>">
                    ...
                    <div class="item--holder">
                        <?php if($show_date == 'true'): ?>
                            <div class="item-date"><i class="zmdi zmdi-calendar-note"></i><?php $date_formart = get_option('date_format'); echo get_the_date($date_formart, $post->ID); ?></div>
                        <?php endif; ?>
                                    ...
                                    <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                        <span>
                                            <?php if(!empty($button_text)) {
                                                ...
                                                echo esc_html__('More Details', 'alico');
                                            } ?>
                                        </span>
