...
$e_header_layout = alico_get_opt('e_header_layout');
$e_header_layout_sticky = alico_get_opt('e_header_layout_sticky');

$e_header_layout_page = alico_get_page_opt('e_header_layout');
if($header_type_page == 'builder' ) {
    $e_header_layout = $e_header_layout_page;
}

$e_header_layout_sticky_page = alico_get_page_opt('e_header_layout_sticky');
if($header_type_page == 'builder' ) {
    $e_header_layout_sticky = $e_header_layout_sticky_page;
}

$logo_m = alico_get_opt( 'logo_mobile', array( 'url' => get_template_directory_uri().'/assets/images/logo-dark.png', 'id' => '' ) );
$e_logo_mobile = alico_get_page_opt( 'e_logo_mobile' );
if($header_type_page == 'builder' && !empty($e_logo_mobile['url']) ) {
                    ...
                    <div class="ct-header-navigation">
                        <nav class="ct-main-navigation">
                            <div class="ct-main-navigation-inner">
                                ...
                                <?php } ?>
                                <?php alico_header_mobile_search(); ?>
