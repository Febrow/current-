...
?>
<div class="ct-fancy-box ct-fancy-box-layout6 <?php echo esc_attr($settings['style_l6'].' '.$settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
