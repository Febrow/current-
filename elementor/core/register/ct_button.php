...
ct_add_custom_widget(
    array(
        'name' => 'ct_button',
        'title' => esc_html__('Case Button', 'alico' ),
        'icon' => 'eicon-button',
                    ...
                    'controls' => array(
                        array(
                            ...
                            'options' => [
                                ...
                                'ct-btn-gradient' => esc_html__('Gradient', 'alico' ),
                            ],
                        ),
                        array(
                            'name' => 'text',
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .btn .ct-button-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                            ],
                        ),
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .btn.ct-align-icon-left .ct-button-icon i' => 'margin-right: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_align' => ['left'],
                            ],
                        ...
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .btn.ct-align-icon-right .ct-button-icon i' => 'margin-left: {{SIZE}}{{UNIT}};',
                            ],
                            'condition' => [
                                'icon_align' => ['right'],
                            ],
