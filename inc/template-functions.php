...
$link = str_replace( 'Reply', ''.esc_attr__('Reply', 'alico').'', $link );
return $link;
}
...
function alico_add_posttype( $postypes ) {
	...
	$postypes['header'] = array(
		'status'     => true,
		'item_name'  => esc_html__( 'Header Builder', 'alico' ),
		'items_name' => esc_html__( 'Header Builder', 'alico' ),
		'args'       => array(
	...
	$postypes['footer'] = array(
		'status'     => true,
		'item_name'  => esc_html__( 'Footer Builder', 'alico' ),
		'items_name' => esc_html__( 'Footer Builder', 'alico' ),
		'args'       => array(
			'menu_icon'          => 'dashicons-editor-insertmore',
			'supports'           => array(
				'title',
...
add_action( 'ct-ie-import-finish', 'alico_update_el_default_kit_option' );
function alico_update_el_default_kit_option(){
	$kit_id = alico_get_id_by_slug('default-kit', 'elementor_library'); 
	if(!empty($kit_id))
...
add_action( 'elementor/preview/enqueue_styles', 'alico_add_editor_preview_style' );
function alico_add_editor_preview_style(){
    wp_add_inline_style( 'editor-preview', alico_editor_preview_inline_styles() );
}
function alico_editor_preview_inline_styles(){
