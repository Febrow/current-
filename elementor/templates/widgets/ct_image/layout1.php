...
?>
<div class="ct-image-single <?php echo esc_attr($ct_animate); ?> <?php if(!empty($settings['img_effect'])) { echo esc_attr($settings['img_effect']); } ?>" data-wow-duration="1.2s" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
